...
//App Colors
@primary-1-color: @blue-400;
@primary-2-color: @blue-700;
@primary-3-color: @blue-200;
@accent-1-color: @red-400;
@accent-2-color: @red-900;
@accent-3-color: @red-100;

//Text Colors
@body-text-color: @dark-black;

//Header Color
@header-color: @grey-400;
@header-border-color: @grey-200;

//Border Colors
@border-color: @grey-300;
@border-color-light: @grey-100;

//Component Colors
@app-bar-color: @blue-grey-700;
...
@floating-action-button-primary-color: @accent-1-color;
@floating-action-button-primary-icon-color: @white;
@floating-action-button-primary-hover-color: @raised-button-primary-hover-color;
@floating-action-button-primary-ripple-color: @raised-button-primary-ripple-color;
@floating-action-button-primary-focus-ripple-color: @raised-button-primary-ripple-color;

@floating-action-button-color: @raised-button-color;
@floating-action-button-icon-color: @raised-button-text-color;
@floating-action-button-hover-color: @raised-button-hover-color;
@floating-action-button-ripple-color: @raised-button-ripple-color;
@floating-action-button-focus-ripple-color: @raised-button-focus-ripple-color;
...
// switches
@switches-ripple-color: fade(@accent-1-color, 20%);

// radio button
@radio-button-size: 24px;
@radio-button-border-color:  @body-text-color;
@radio-button-background-color: white;
@radio-button-checked-color: @accent-1-color;
@radio-button-required-color: @accent-1-color;
@radio-button-disabled-color: @disabled-color;

// checkbox
@checkbox-box-color: @body-text-color;
@checkbox-checked-color: @accent-1-color;
@checkbox-required-color: @accent-1-color;
...
// toggle
@toggle-size: 20px;
@toggle-thumb-on-color: @accent-1-color;
@toggle-thumb-off-color: @grey-50;
@toggle-thumb-disabled-color: @grey-400;
@toggle-thumb-required-color: @accent-1-color;
