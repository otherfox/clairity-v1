...
export function updateLocation(location, sameAsCustomer = false) {
  return new Promise((s, f) => {
    let payload = {};
    ...
    payload.reference_number = location.customer.reference_num || "";
    payload.customerLegacyAccountNumber = location.customer.legacy_account_num || "";
    ...
    payload.location_reference_number = location.reference_num || "";
    payload.legacy_account_number = location.legacy_account_num || "";
