...
import {getAgingReports} from './actions'
import {getActive, getInactive, getAll} from './queries'
...
let colNames = [
  ...
  { name: '0 - 30', type: 'currency'},
  { name: '31 - 60', type: 'currency'},
  { name: '61 - 90', type: 'currency'},
  { name: '91+', type: 'currency'},
  { name: 'Send Late Notice', type: 'send'},
  { name: 'Last Weekly Notice', type: 'date'},
  { name: 'Last Monthly Notice', type: 'date'},
