...
import {requestLocationById, requestUpdateLocation} from '../shared/actions/location'
import {getLocationById} from '../shared/queries/locations'
import {requestAllCustomerTypes} from '../shared/actions/customer'
import {getAllCustomerTypes} from '../shared/queries/customers'
...
export default class CreateLocation extends React.Component {
  ...
  updateState() {
    let location = getLocationById(this.getLocationId());
    let customerTypesRaw = getAllCustomerTypes();
  ...
  onSubmit() {
    ...
    requestUpdateLocation(this.state).then(() => {
