          ...
          <Content>
            <div>
              ...
              <Paper zDepth={1} rounded={true}>
                <Layout widths={{ lg: [3, 9], md: [12, 12], sm: [3, 9], xs: [3, 9]}} cPadding={'0 20px 20px 20px'}>
                  <div>
                    <h4>Details</h4>
                    <Layout widths={{ lg: [12,12,12,12,12,12,12], md: [12,12,12,12,12,12,12], sm: [12,12,12,12,12,12,12], xs: [12,12,12,12,12,12,12]}}>
                      <TextField
                        defaultValue="Pleasanton Site"
                        floatingLabelText="Customer"
                        disabled={true} />
                      <TextField
                        defaultValue="1845 Oil Field Services"
                  ...
                  <div>
                    <h4>Services</h4>
                    <Paper>
                      <Layout widths={{ lg: [4, 1, 1.5, 1.5, 4], md: [4, 1.5, 1.5, 2, 3], sm: [3,2,2,2,3], xs: [3,2,2,2,3]}} cPadding={'0 20px 0 0'} pPadding={'0 20px'} type="row">
