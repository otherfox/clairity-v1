...
import {requestLocationById, requestUpdateLocation} from '../../actions/location'
import {getLocationById} from '../../queries/locations'
import {requestAllCustomerTypes} from '../../actions/customer'
import {getAllCustomerTypes} from '../../queries/customers'
                ...
                <Layout widths={{ lg: [6, 6], md: [12, 12], sm: [12, 12], xs: [12, 12]}} cPadding={'0 20px 20px 20px'}>
                  ...
                  <div>
                    ...
                    <Layout widths={{ lg: [12,12,12,6,6,12,6,6,4,4,4], md: [12,12,12,12,12,12,12], sm: [12,12,12,12,12,12,12], xs: [12,12,12,12,12,12,12]}}>
                      ...
                      <TextField
                        name="reference_num"
                        value={location.reference_num}
                        onChange={this.handleLocationChange.bind(this)}
                        floatingLabelText="Reference #" />
                      <TextField
                        name="legacy_account_num"
                        value={location.legacy_account_num}
                        onChange={this.handleLocationChange.bind(this)}
                        floatingLabelText="Legacy Account #" />
                      <TextField
                        name="order_index"
