...
import CustomerOverview from '../shared/components/workOrders/customerOverview'
        ...
        <Layout type="main">
          ...
          <Content>
            <div>
              ...
              <Layout widths={{lg: [],md: [], sm: [], xs: [], xxs: [], }}>
                <div><CustomerOverview></CustomerOverview></div>
                <div><ContractOverview></ContractOverview></div>
