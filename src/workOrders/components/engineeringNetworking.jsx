      ...
      <div style={this.props.style}>
        <Paper zDepth={1} rounded={true}>
          <Layout widths={{lg:[12],md:[12],sm:[12],xs:[12]}} pPadding={'0 20px 20px 20px'}>
            <div>
              <h3>Engineering Networking</h3>
              <Layout widths={{lg:[6,6],md:[12,12],sm:[12,12],xs:[12,12]}} pPadding={'20px 20px 0 0'}>
                <div>
                  <Details
                    data = {[
                      ...
                      { label: 'IPs Requested', name: 'ips_requested', value:  <TextField multiLine={true} defaultValue={'/30'} />, detailType: 'muiTextField'},

                      { label: 'Customer IP Block', name: 'customer_ip_block', value:  <TextField multiLine={true} defaultValue={'216.59.217.8/30'} />, detailType: 'muiTextField'},

                      { label: 'Subnet Mask', name: 'subnet_mask', value:  <TextField multiLine={true} defaultValue={'255.255.255.252'} />, detailType: 'muiTextField'},

                      { label: 'Gateway', name: 'gateway', value:  <TextField multiLine={true} defaultValue={'216.59.217.9'} />, detailType: 'muiTextField'},
              ...
              <div>
                <Details
                  data = {[
                    ...
                    { label: 'IPs Requested', name: 'ips_requested_2', value:  <TextField multiLine={true} defaultValue={'infrastructure'} />, detailType: 'muiTextField'},

                    { label: 'Customer IP Block', name: 'customer_ip_block_2', value:  <TextField multiLine={true} defaultValue={'216.59.210.240/30'} />, detailType: 'muiTextField'},

                    { label: 'Subnet Mask', name: 'subnet_mask_2', value:  <TextField multiLine={true} defaultValue={'255.255.255.252'} />, detailType: 'muiTextField'},

                    { label: 'Gateway', name: 'gateway_2', value:  <TextField multiLine={true} defaultValue={'216.59.210.241'} />, detailType: 'muiTextField'},
                    ...
                    { label: 'BGP AS Number', name: 'vlan_id', value:  <TextField multiLine={true} defaultValue={'39 mgt 240 data'} />, detailType: 'muiTextField'},

                    { label: 'Router Ports', name: 'router_ports', value:  <TextField multiLine={true} defaultValue={'fa0/14'} />, detailType: 'muiTextField'},

                    { label: 'Notes', name: 'networking_notes', value:  <TextField multiLine={true} />, detailType: 'muiTextField'},
